Shader "Water/WaterReflectionSolid"
{
	Properties
	{
	...
	SubShader
	{
		...
		CGPROGRAM
			...
			{
				float2 disp = tex2D(_DisplaceTex, (IN.worldPos.xy * .2) + frac(_Time.x *  float2(_SpeedX, _SpeedY))).xy;
				disp = ((disp * 2) - 1) * _Magnitude;
				fixed4 c = SampleSpriteTexture (IN.texcoord + disp);
